...
var JobListComponent = /** @class */ (function () {
    function JobListComponent(httpService) {
    ...
    JobListComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.httpService.getApi("job/jobs?offset=" + this.pagination.offset + "&limit=" + this.pagination.limit).subscribe(function (res) {
            _this.jobList = res['data'];
            _this.pagination.total = res['count'];
        });
    };
    JobListComponent.prototype.pageChange = function (pageNo) {
        var _this = this;
    ...
    JobListComponent.prototype.syncJob = function () {
        var _this = this;
        this.httpService.postApi('', 'job/sync').subscribe(function (res) {
            _this.httpService.getApi("job/jobs?offset=" + _this.pagination.offset + "&limit=" + _this.pagination.limit).subscribe(function (res) {
                _this.jobList = res['data'];
                _this.pagination.total = res['count'];
            });
        });
...
var HttpServiceService = /** @class */ (function () {
    ...
    HttpServiceService.prototype.getApi = function (url) {
    ...
    HttpServiceService.prototype.postApi = function (json, url) {
